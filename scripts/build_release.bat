...
rem ===================================================================
rem  FallingStars - Release build (Win32/x86), fully self-contained.
...
echo [FallingStars] Release build OK: %~dp0..\Release\FallingStars.dll
exit /b 0

:failed
echo [FallingStars] Release build FAILED (errorlevel %errorlevel%).
pause
exit /b 1
